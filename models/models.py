...
class ActuacionJudicial(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    idIncidenteJudicaturaCompleto = Column(Integer, ForeignKey('incidente_judicatura_completo.id'))
...
class ListaLitiganteActor(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    idListaIncidenteJudicatura = Column(Integer, ForeignKey('lista_incidente_judicatura.id'))
